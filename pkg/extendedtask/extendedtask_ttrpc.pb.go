...
type ExtendedTaskService interface {
	...
	CreateSocket(context.Context, *CreateSocketRequest) (*CreateSocketResponse, error)
}
...
func RegisterExtendedTaskService(srv *ttrpc.Server, svc ExtendedTaskService) {
	srv.RegisterService("ExtendedTask", &ttrpc.ServiceDesc{
		Methods: map[string]ttrpc.Method{
			...
			"CreateSocket": func(ctx context.Context, unmarshal func(interface{}) error) (interface{}, error) {
				var req CreateSocketRequest
				if err := unmarshal(&req); err != nil {
					return nil, err
				}
				return svc.CreateSocket(ctx, &req)
			},
		},
	})
}
...
func (c *extendedtaskClient) CreateSocket(ctx context.Context, req *CreateSocketRequest) (*CreateSocketResponse, error) {
	var resp CreateSocketResponse
	if err := c.client.Call(ctx, "ExtendedTask", "CreateSocket", req, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
